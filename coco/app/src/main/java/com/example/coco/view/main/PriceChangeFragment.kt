...
class PriceChangeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.arr15min.observe(viewLifecycleOwner, Observer {
            ...
            val priceUpDownRVAdapter = PriceListUpDownRVAdapter(requireContext(), it)
            binding.price15m.adapter = priceUpDownRVAdapter
        ...
        viewModel.arr30min.observe(viewLifecycleOwner, Observer {
            ...
            val priceUpDownRVAdapter = PriceListUpDownRVAdapter(requireContext(), it)
            binding.price30m.adapter = priceUpDownRVAdapter
        ...
        viewModel.arr45min.observe(viewLifecycleOwner, Observer {
            ...
            val priceUpDownRVAdapter = PriceListUpDownRVAdapter(requireContext(), it)
            binding.price45m.adapter = priceUpDownRVAdapter
